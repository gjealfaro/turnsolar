...
export const PASSWORDS = {
  admin: 'admin1234',  // Full access: create offers + manage products
  user: 'solar2024',  // Limited: create offers only
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ role, login, logout, isAdmin: role === 'admin', isLoggedIn: role !== null }}>
      {children}
